...
We can define the predicate equ? which checks whether two general numbers are equal:
...
(define r2 (make-rational (make-fraction 2 4)))
(define r3 (make-rational (make-fraction 1 3)))
